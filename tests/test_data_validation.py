...
def sample_data():
    ...
    data = {
        'timestamp': pd.to_datetime(['2023-01-01 00:00:00', '2023-01-01 01:00:00', '2023-01-01 02:00:00', '2023-01-01 03:00:00']),        'open': [1.0, 1.1, 0.9, 1.2],
...
def test_check_time_continuity(validator, sample_data):
    ...
    invalid_data = sample_data.copy()
    invalid_data.loc[2, 'timestamp'] = invalid_data.loc[2, 'timestamp'] + timedelta(hours=2)
...
def changepoint_data():
    ...
    timestamps = pd.to_datetime(pd.date_range(start='2023-01-01', periods=200, freq='h'))
    return pd.DataFrame({
